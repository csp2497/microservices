...
public class CalculatorRibbonConfiguration {
	 ...
	 * you’ll recall, a method mapped to the /path; that means that Ribbon will get
	 * an HTTP 200 response when it pings a running Backend Server
	 *
	...
	/**
	 * AvailabilityFilteringRule will use Ribbon’s built-in circuit breaker
